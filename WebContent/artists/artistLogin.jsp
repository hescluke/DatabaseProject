...
<head>
    ...
    <style type="text/css">
        ...
        .btn-primary {
            background-color: rgba(229, 96, 1, 0.3);
            background-size: 100px;
            background-image: -moz-linear-gradient(top, rgba(248, 140, 63, 0.3), rgba(229, 96, 1, 0.3));
            background-image: -ms-linear-gradient(top, rgba(248, 140, 63, 0.3), rgba(229, 96, 1, 0.3));
            background-image: -webkit-gradient(linear, 0 0, 0 100%, from(rgba(248, 140, 63, 0.3)),
            to(rgba(229, 96, 1, 0.3)));
            background-image: -webkit-linear-gradient(top, rgba(248, 140, 63, 0.3), rgba(229, 96, 1, 0.3));
            background-image: -o-linear-gradient(top, rgba(248, 140, 63, 0.3), rgba(229, 96, 1, 0.3));
            background-image: linear-gradient(top, rgba(248, 140, 63, 0.3), rgba(229, 96, 1, 0.3));
            background-repeat: repeat-x;
            /*filter: alpha(opacity:50);*/
            filter: progid:dximagetransform.microsoft.gradient(startColorstr=rgba(248, 140, 63, 0.3),
            endColorstr=rgba(238, 115, 27, 0.3), GradientType=0);
            border: 1px solid rgba(229, 96, 1, 0.3);
        ...
        .btn-primary.disabled, .btn-primary[disabled] {
            filter: none;
            background-color: rgba(245, 127, 43, 0.3);
        }
...
<div class = login>
    ...
    <form
            action="${pageContext.request.contextPath}/artist/ArtistServlet?op=login"
            method="post">
        ...
        <button type="submit" class="btn btn-primary" style="width:95px">Login</button>
        <button type="button" class="btn btn-primary"
                data-dismiss="modal" onclick=window.location.href="${pageContext.request.contextPath}/artist/artistRegister.jsp"
                style="width:95px">Register
        </button>
        <button type="button" class="btn btn-primary"
<%--                data-dismiss="modal" onclick=window.location.href="${pageContext.request.contextPath}/client/ClientServlet?op=category"--%>
                onClick="javascript:history.go(-1);"
                style="width:95px">Return
        </button>
    </form>
</div>
