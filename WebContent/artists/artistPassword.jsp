...
<div style="margin-top: 100px; margin-left: 400px">
    <form action="<%=basePath%>/artist/ArtistServlet?op=artistPassword"
          method="post">
        ...
        <div class="form-group">
            <input
                    class="form-control" type="hidden" id="artist_name" name="artist_name" value="${sessionScope.artist.artist_name}"
                    readonly
                    style="width: 700px">
        </div>
        <br>
        <button type="submit" class="btn btn-primary"
                onclick="window.location='artist/ArtistServlet?op=artistPassword'">提交</button>
        <button type="button" class="btn btn-default" data-dismiss="modal"
                style="margin-left: 100px"
                onclick="window.location='artistIndex.jsp'">关闭</button>
    </form>
</div>
</body>
</html>