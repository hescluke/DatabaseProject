...
<div
    ...
    <div style="padding-top: 9px">
        <span style="font-size: 25px; margin-left: 20px;">《${song.song_name}》</span><a
...
<div
    ...
    <div
        ...
        <img
                ...
                src="${pageContext.request.contextPath}/img/books/${song.song_name}.png"/>
    </div>
    <div style="width: 640px; height: 600px; float: right;">
        <!-- 歌曲名称 -->
        <div style="margin-top: 25px">
				<span
                        style="font: 700 16px Arial, 'microsoft yahei'; color: #666; padding-top: 10px; line-height: 28px; margin-bottom: 5px; margin-left: 10px">《${song.song_name}》</span>
        </div>
        <!-- 作者出版社 -->
        <div style="margin-left: 18px; margin-top: 15px">
            <span style="font-size: 20px; color: #1890FF;">${song.song_press}</span>
            &nbsp;<strong>编</strong>&nbsp;&nbsp;&nbsp; <span
                style="font-size: 20px; color: #1890FF;">${song.song_artist}</span>
            &nbsp;<strong>著</strong>
        </div>
        <!-- 价格&销量 -->
        <div
            ...
            <div style="margin-top: 20px; margin-left: 30px">
                <span style="color: rgb(153, 153, 153)">所属分类:</span>&nbsp;&nbsp;&nbsp;${song.category.category_name}<br>
                <span style="color: rgb(153, 153, 153)">歌词:</span>
                <textarea disabled="disabled" class="form-control" rows="3"
                          id="song_desc" name="song_desc" placeholder="${song.song_desc}"
                          style="width: 570px; margin-top: 7px; margin-bottom: 7px"></textarea>
                <span style="color: rgb(153, 153, 153)">歌曲单价:</span><span
                    style="font-size: 16px; font-weight: 700; color: #C62E2D">&nbsp;&nbsp;￥${song.song_price}</span><br>
                <span style="color: rgb(153, 153, 153)">歌曲库存:</span>&nbsp;&nbsp;&nbsp;${song.song_kunumber}&nbsp;本<br>
                <span style="color: rgb(153, 153, 153)">歌曲销量:</span>&nbsp;&nbsp;&nbsp;${song.song_xiaonumber}&nbsp;本<br>
            </div>
        </div>
        <!-- 收藏 -->
        ...
        <div style="margin-top: 60px; margin-left: 120px">
            ...
            <button id="bt2" type="button" class="btn btn-danger"
                    style="background-color: rgb(198, 46, 45); width: 160px; height: 43px; margin-left: 100px">
						<span style="font-size: 16px " ><a href="<%=basePath%>/client/ClientServlet?op=buyNow&song_id=${song.song_id}">立即购买</a></span>
                                </button>
             </c:if>
            <c:if test="${empty user}">
