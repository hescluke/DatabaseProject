...
<body><script type="text/javascript" src="js/texiao.js"></script>
	...
	<div>
		<p style="font-size: 25px; margin-top: 20px; margin-left: 42px">添加歌曲分类</p>
	</div>
	<hr
	...
	<form style="margin-top: 30px; margin-left: 450px"
		...
		<div class="form-group">
			<label>歌曲分类名称：</label> <input type="text" class="form-control"
				id="category_name" name="category_name" placeholder="歌曲分类名称"
				style="width: 700px">
		</div>
		<div class="form-group">
			<label>歌曲分类描述：</label>
			<textarea class="form-control" rows="3" id="category_desc"
				name="category_desc" placeholder="歌曲分类描述" style="width: 700px"></textarea>
		</div>
		<br>
