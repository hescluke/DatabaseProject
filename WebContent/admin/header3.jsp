    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a href="<%=basePath%>/client/ClientServlet?op=category" target="_top"><img style="ackground-size:contain;height: 50px;width: 50px"
                                                                              src="<%=basePath%>/img/tou.png" />
                    <font style="color: #080808; font-size: 30px;font-family: 华文行楷">酷音乐库</font>
                </a>
                <c:if test="${!empty user}">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome dear <span
                    style="color: red; font-weight: bold">${sessionScope.user.name}</span>&nbsp;!&nbsp;&nbsp;&nbsp;Please enjoy yourself in COOL MUSIC!
...
<%--                        <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" 111--%>
<%--                             aria-labelledby="myModalLabel">--%>
<%--                            <div class="modal-dialog" role="document">--%>
<%--                                <div class="modal-content">--%>
<%--                                    <div class="modal-header">--%>
