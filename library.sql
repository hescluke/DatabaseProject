...
-- ----------------------------
-- Table structure for songdb
-- ----------------------------
DROP TABLE IF EXISTS `songdb`;
CREATE TABLE `songdb`  (
  `song_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `song_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `song_artist` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `song_press` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `song_category` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `filename` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `song_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `song_price` double(10, 0) NOT NULL,
  `song_kunumber` int(11) NOT NULL,
  `song_xiaonumber` int(11) NOT NULL,
  PRIMARY KEY (`song_id`) USING BTREE,
  INDEX `songdb_ibfk_1`(`song_category`) USING BTREE,
  CONSTRAINT `songdb_ibfk_1` FOREIGN KEY (`song_category`) REFERENCES `category` (`category_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of songdb
-- ----------------------------
INSERT INTO `songdb` VALUES ('2c086867-bcac-4d8a-b060-dc74ed5b3f3b', '《深入了解计算机系统》', 'HaC', 'HelloCoder出版社', '143c60c6-e608-46cc-b846-620d0404f958', 'csapp.jpg', 'songs', '', 100, 4, 1);
INSERT INTO `songdb` VALUES ('a5ce0bd0-c4cc-4b5a-8574-7a82649a2794', '《Unix编程艺术》', 'HaC', 'HelloCoder出版社', 'c6cf2402-c04a-426d-a339-8ea029bd5689', 'unix.jpg', 'songs', 'HelloCoder出版社的主编HaC大神亲自写的Unix编程书，值得一看', 60, 100, 0);
INSERT INTO `songdb` VALUES ('ad79a235-ae1b-4ca2-9b08-b3f06caa23d0', '《程序员颈椎康复指南》', 'HaC', 'HelloCoder出版社', 'c6cf2402-c04a-426d-a339-8ea029bd5689', 'jingzhui.jpg', 'songs', '帮助程序员康复颈椎的一本书', 40, 100, 0);
...
CREATE TABLE `favorite`  (
  ...
  `song_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  CONSTRAINT `favorite_ibfk_2` FOREIGN KEY (`song_id`) REFERENCES `songdb` (`song_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `orderitems`  (
  ...
  `song_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ordernum` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `song_id_fk`(`song_id`) USING BTREE,
  INDEX `ordernum_fk`(`ordernum`) USING BTREE,
  CONSTRAINT `song_id_fk` FOREIGN KEY (`song_id`) REFERENCES `songdb` (`song_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
